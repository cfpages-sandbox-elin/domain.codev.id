...
export const WHOIS_PROVIDER_REGISTRY: WhoisProviderConfig[] = [
  ...
  },
  {
    ...
    enabled: true,
    priority: 11,
    envKeys: ['OTI_LABS_API_KEY', 'RAPIDAPI_KEY'],
    freeTierLabel: '1,000 requests/month through RapidAPI',
    supportsQuotaHeaders: false,
    monthlyFreeLimit: 1000,
    perMinuteLimit: 10,
    notes: 'RDAP-first RapidAPI provider with port-43 fallback. Uses user-stored oti-labs, OTI_LABS_API_KEY, or shared RAPIDAPI_KEY.',
    isConfigured: credentials => Boolean(credentials?.['oti-labs'] || OTI_LABS_API_KEY || RAPIDAPI_KEY),
  },
  {
    id: 'domainduck',
    label: 'Domainduck',
